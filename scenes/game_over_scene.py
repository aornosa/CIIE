...
--------------------------
Pantalla de game over única para todo el juego.
Acepta un dict `stats` libre — muestra las claves que reciba.

Uso desde level1_scene (muerte en arena):
    GameOverScene(stats={"kills": 12, "coins": 340})

Uso desde WaveManager / game legacy (fin de oleadas):
    GameOverScene(stats={"score": 4200, "wave": 7})

Ambos modos son válidos; se muestran las líneas que estén presentes.
"""
import pygame
...
class GameOverScene(Scene):
    ...
    stats : dict
        ...
        Las claves presentes se muestran; las ausentes se omiten.
    """
    ...
    def render(self, screen):
        ...
        for key in ("wave", "score", "kills", "coins"):
            ...
            line  = self._font_stat.render(f"{label}:  {value}", True, _STAT_COLOR)
